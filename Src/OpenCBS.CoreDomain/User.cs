...
namespace OpenCBS.CoreDomain
{
    ...
    public class User:IComparable
    {
        ...
        public bool HasAdminRole
        {
            get
            {
                return UserRole.RoleName.ToString() == Roles.ADMIN.ToString()
                    ||
                    UserRole.RoleName.ToString() == Roles.SUPER.ToString();
                //return (_role == Roles.ADMIN.ToString()) || (_role == Roles.SUPER.ToString());
            }
        }

        public bool HasCashierRole
        {
            get
            {
                return UserRole.RoleName.ToString() == Roles.CASHI.ToString();
            }
        }
        ...
        public IEnumerable<Teller> Tellers
        {
            get
            {
                foreach (Teller teller in _tellers)
                    yield return teller;
            }
        }
        ...
        public int? FrapidLoginId { get; set; }
