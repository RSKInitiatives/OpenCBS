...
namespace OpenCBS.Services
{
    public class TellerServices : Services
    {
        ...
        public List<Teller> FindTellersByUser(User user)
        {
            return _manager.SelectAllOfUser(user.Id).FindAll(item => !item.Deleted);
        }
        ...
        {
            return _manager.GetCurrentCashPosition(teller);
        }
