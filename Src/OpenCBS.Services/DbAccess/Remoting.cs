...
namespace OpenCBS.Services
{
    public class Remoting : IServices
    {
        ...
        {
            return _remoteOperation.GetEmailAccountServices(CurrentUser);
        }

        public MessageTemplateServices GetMessageTemplateServices()
        {
            return _remoteOperation.GetMessageTemplateServices(CurrentUser);
        }

        public QueuedEmailServices GetQueuedEmailServices()
        {
            return _remoteOperation.GetQueuedEmailServices(CurrentUser);
        }


        public QueuedSMSServices GetQueuedSMSServices()
        {
            return _remoteOperation.GetQueuedSMSServices(CurrentUser);
        }


        public SavingEventServices GetSavingEventServices()
        {
            return _remoteOperation.GetSavingEventServices(CurrentUser);
        }
    }
}
