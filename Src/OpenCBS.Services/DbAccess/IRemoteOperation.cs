...
namespace OpenCBS.Services
{
    public interface IRemoteOperation
    {
        ...
        AccountServices GetSavingServices(User pUser);
        ...
        EmailAccountServices GetEmailAccountServices(User user);
        MessageTemplateServices GetMessageTemplateServices(User user);
        QueuedEmailServices GetQueuedEmailServices(User user);
        QueuedSMSServices GetQueuedSMSServices(User CurrentUser);
        SavingEventServices GetSavingEventServices(User CurrentUser);
