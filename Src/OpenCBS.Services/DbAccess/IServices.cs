...
namespace OpenCBS.Services
{
    public interface IServices
    {
        ...
        AccountServices GetAccountServices();
        ...
        EmailAccountServices GetEmailAccountServices();
        MessageTemplateServices GetMessageTemplateServices();
        QueuedEmailServices GetQueuedEmailServices();
        QueuedSMSServices GetQueuedSMSServices();
        SavingEventServices GetSavingEventServices();
