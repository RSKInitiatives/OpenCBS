...
namespace OpenCBS.Shared.Settings
{
    ...
    public class ApplicationSettings
    {
        ...
        private void FillDefaultParamList()
        {
            ...
            _defaultParamList.Add(OGeneralSettings.SMS_GATEWAY_USERNAME, "estoresms_username");
            _defaultParamList.Add(OGeneralSettings.SMS_GATEWAY_PASSWORD, "estoresms_password");
            _defaultParamList.Add(OGeneralSettings.SMS_FROM_NUMBER, "sms_from_number");
            _defaultParamList.Add(OGeneralSettings.SMS_CHARGE, "4");

            _defaultParamList.Add(OGeneralSettings.STAMP_DUTY_VALID_ABOVE, "1000");

            _defaultParamList.Add(OGeneralSettings.ENABLE_SMS_MESSAGING, "1");
            _defaultParamList.Add(OGeneralSettings.AUTOMATE_CHEQUE_DEPOSIT, "1");
            _defaultParamList.Add(OGeneralSettings.TELLER_MANAGEMENT, "1");
        ...
        public bool UseTellerManagement
        {
            ...
            { 
                //return false;
                return (string)GetSpecificParameter(OGeneralSettings.TELLER_MANAGEMENT).ToString() == "1";
            }
        }
        ...
        public int ApplicationTimeout
        {
            get
            {
                // postpone auto-logout by 15 minutes
                int defaultTimeOut = 15;
                var appTimeOut = GetSpecificParameter(OGeneralSettings.APPLICATION_TIMEOUT) ?? defaultTimeOut;
                return Convert.ToInt32(appTimeOut) * 1000 * 60;
            }
        }
        ...
        public bool EnablePayroll
        {
            get { return GetSpecificParameter(OGeneralSettings.ENABLE_PAYROLL).ToString() == "1"; }
        }
