...
namespace OpenCBS.ArchitectureV2.View
{
    public partial class LoginView : BaseView, ILoginView
    {
        ...
        public void StartDatabaseListRefresh()
        {
            ...
            secretQuestionAnswerTextBox.Enabled = false;
        ...
        public void StopDatabaseListRefresh()
        {
            ...
            secretQuestionAnswerTextBox.Enabled = true;
        ...
        {
            get { return secretQuestionAnswerTextBox.Text; }
            set { secretQuestionAnswerTextBox.Text = value; }
        }
