...
namespace OpenCBS.Enums
{
    ...
    public static class OSavingEvents
    {
        ...
        public const string InstrumentFee = "SIFE"; // Saving Instrument Fee Event
        public const string SearchFee = "SSFE"; // Saving Search Fee Event
        public const string DutyStampFee = "SDFE"; // Saving Duty Stamp Fee Event
        public const string AMFee = "SAFE"; // Saving Account Manitenance Fee Event
