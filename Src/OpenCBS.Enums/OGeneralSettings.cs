...
namespace OpenCBS.Enums
{
    public static class OGeneralSettings
    {
        ...
        public static readonly string SMS_GATEWAY_USERNAME = "SMS_GATEWAY_USERNAME";
        public static readonly string SMS_GATEWAY_PASSWORD = "SMS_GATEWAY_PASSWORD";
        public static readonly string SMS_FROM_NUMBER = "SMS_FROM_NUMBER";
        public static readonly string SMS_CHARGE = "SMS_CHARGE";

        public static readonly string CHEQUE_CLEAR_PERIOD = "CHEQUE_CLEAR_PERIOD";
        public static readonly string STAMP_DUTY_VALID_ABOVE = "STAMP_DUTY_VALID_ABOVE";

        public static readonly string ENABLE_SMS_MESSAGING = "ENABLE_SMS_MESSAGING";
        public static readonly string AUTOMATE_CHEQUE_DEPOSIT = "AUTOMATE_CHEQUE_DEPOSIT";

        public static readonly string ENABLE_PAYROLL = "ENABLE_PAYROLL";

        public static readonly string TELLER_MANAGEMENT = "TELLER_MANAGEMENT";

        public static readonly string APPLICATION_TIMEOUT = "APPLICATION_TIMEOUT";
