...
namespace OpenCBS.Enums
{
    ...
    public static class OTellerEvents
    {
        ...
        public const string CloseDayPositiveDifference = "CPDE";//"CDPD"; // Close Day Positive Difference
        public const string CloseDayNegativeDifference = "CNDE";//"CDND"; // Close Day Negative Difference
    }
}
