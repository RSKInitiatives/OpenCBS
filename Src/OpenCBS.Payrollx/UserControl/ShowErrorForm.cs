...
namespace OpenCBS.Payroll
{
	/// <summary>
	/// Summary description for frmShowError.
	/// </summary>
	public class ShowErrorForm : Form
	{
		...
		public ShowErrorForm(ExceptionStatus pExceptionStatus)
		{
			InitializeComponent();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ShowErrorForm));
