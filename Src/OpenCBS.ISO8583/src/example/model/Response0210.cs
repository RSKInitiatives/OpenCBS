...
namespace Free.iso8583.example.model
{
    ...
    [MessageType(Seq = 2, Value = new byte[] { 0x02, 0x10 })]
    [BitMap(Seq = 3, Length = 8)]
    public class Response0210 : BaseModel
    {
        public Response0210()
        {
        }
        public Response0210(Object aModel) : base(aModel)
        {
        }
        ...
        [PropertyField(Seq = 48, FieldType = FieldType.ANS, LengthHeader = 2, Tlv = typeof(ResponseDataEntry48))]
    ...
    public class RespCashWithdrawal0210 : Response0210
    {
        public RespCashWithdrawal0210()
        {
        }
        public RespCashWithdrawal0210(Object aModel) : base(aModel)
        {
        }
    }
    public class RespPayment0210 : Response0210
    {
        public RespPayment0210()
        {
        }
        public RespPayment0210(Object aModel) : base(aModel)
        {
        }
    }
    public class RespTransfer0210 : Response0210
    {
        public RespTransfer0210()
        {
        }
        public RespTransfer0210(Object aModel) : base(aModel)
        {
        }
    }
}
