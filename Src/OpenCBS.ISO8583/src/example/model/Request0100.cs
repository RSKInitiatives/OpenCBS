...
namespace Free.iso8583.example.model
{
    ...
    [MessageType(Seq = 2, Value = new byte[] { 0x01, 0x00})]
    [BitMap(Seq = 3, Length = 8)]
    public class Request0100 : BaseModel
    {
        public Request0100()
        {
        }
        public Request0100(Object aModel) : base(aModel)
        {
        }
    ...
    public class ReqBalanceInquiry0100 : Request0100
    {
        public ReqBalanceInquiry0100()
        {
        }
        public ReqBalanceInquiry0100(Object aModel) : base(aModel)
        {
        }
    }

    public class ReqPinChange0100 : Request0100
    {
        public ReqPinChange0100()
        {
        }
        public ReqPinChange0100(Object aModel) : base(aModel)
        {
        }
    }

    public class ReqPaymentInquiry0100 : Request0100
    {
        public ReqPaymentInquiry0100()
        {
        }
        public ReqPaymentInquiry0100(Object aModel) : base(aModel)
        {
        }
    }

    public class ReqTransferInquiry0100 : Request0100
    {
        public ReqTransferInquiry0100()
       {
       }
       public ReqTransferInquiry0100(Object aModel) : base(aModel)
        {
        }
    }
}
