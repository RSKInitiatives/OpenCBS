...
namespace OpenCBS.Manager.Events
{
	public class SavingEventManager : Manager
	{
	    ...
	    private static void SetInsertCommandForSavingEvent(OpenCbsCommand c, SavingEvent pSavingEvent, int pSavingContractId)
	    {
            ...
            c.AddParam("@reference_number", pSavingEvent.ReferenceNumber);
            ...
            if (pSavingEvent.IsLocal.HasValue)
	            c.AddParam("@is_local", (bool)pSavingEvent.IsLocal.Value);
            else
                c.AddParam("@is_local", null);
        ...
        public List<SavingEvent> SelectEvents(string code)
        {
        ...
        public List<SavingEvent> SelectEventsByTellerId(int tellerId)
        {
            const string q = @"SELECT  
                                        SavingEvents.id ,
                                        SavingEvents.user_id ,
                                ...
                                INNER JOIN dbo.SavingContracts sc 
                                  ON SavingEvents.contract_id = sc.id
				                WHERE SavingEvents.teller_id = @teller_id 
                                ORDER BY SavingEvents.id";
            using (SqlConnection conn = GetConnection())
            using (OpenCbsCommand c = new OpenCbsCommand(q, conn))
            {
                c.AddParam("@teller_id", tellerId);
	    ...
	    private static void SetSavingsEvent(OpenCbsReader r, SavingEvent e, ISavingProduct pProduct)
	    {
            ...
            e.ReferenceNumber = r.GetString("reference_number");
            ...
            e.IsLocal = r.GetNullBool("is_local");
	    ...
	    private static SavingEvent GetSavingsEvent(string code)
	    {
	        ...
	        switch (code)
	        {
	            ...
	            case OSavingEvents.Withdraw:
	                ...
	                break;
                case OSavingEvents.AMFee:
                    e = new SavingAMFeeEvent();
                    break;
	            ...
	            case OSavingEvents.ManagementFee:
	                ...
	                break;
                case OSavingEvents.InstrumentFee:
                    e = new SavingInstrumentFeeEvent();
                    break;
                case OSavingEvents.SearchFee:
                    e = new SavingSearchFeeEvent();
                    break;
                case OSavingEvents.DutyStampFee:
                    e = new SavingDutyStampFeeEvent();
                    break;
