        ...
        public void AddSavingsBookContract(SavingBookContract pSaving, SqlTransaction pSqlTransac)
        {
            const string sqlText = @"INSERT INTO [SavingBookContracts] 
                                    (
                                        ...
                                        [flat_instrument_fees],
                                        [flat_search_fees],
                                        [flat_duty_stamp_fees],
            ...
            using (OpenCbsCommand cmd = new OpenCbsCommand(sqlText, pSqlTransac.Connection, pSqlTransac))
            {
                ...
                cmd.AddParam("@flatAMFees", pSaving.Product.AMFeesType == OSavingsFeesType.Flat ? pSaving.FlatAMFees : null);
                cmd.AddParam("@rateAMFees", pSaving.Product.AMFeesType == OSavingsFeesType.Rate ? pSaving.RateAMFees : null);
                ...
                cmd.AddParam("@flatInstrumentFees", pSaving.InstrumentFees);
                cmd.AddParam("@flatSearchFees", pSaving.SearchFees);
                cmd.AddParam("@flatOtherFees", pSaving.DutyStampFees);
...
//                }
        ...
        public void SelectSavingsBookContract(SavingBookContract saving)
        {
            const string sqlText = @"SELECT
                                            ...
                                            sbc.flat_instrument_fees,
                                            sbc.flat_search_fees,
                                            sbc.flat_duty_stamp_fees,
        ...
        private void GetSavingBookFromReader(SavingBookContract saving, OpenCbsReader reader)
        {
            ...
            saving.FlatAMFees = reader.GetNullDecimal("flat_am_fees");
            saving.RateAMFees = reader.GetNullDouble("rate_am_fees");
            ...
            saving.InstrumentFees = reader.GetNullDecimal("flat_instrument_fees");
            saving.SearchFees = reader.GetNullDecimal("flat_search_fees");
            saving.DutyStampFees = reader.GetNullDecimal("flat_duty_stamp_fees");
