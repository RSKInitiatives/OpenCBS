...
namespace OpenCBS.ExceptionsHandler.Exceptions.SavingExceptions
{
	...
	public class OpenCbsSavingException : OpenCbsException
	{
        ...
        private static string _FindException(OpenCbsSavingExceptionEnum exceptionId)
        {
            ...
            switch (exceptionId)
            {
                case OpenCbsSavingExceptionEnum.SavingBackDateDenied:
                    returned = "SavingBackDateDenied.Text";
                    break;
                case OpenCbsSavingExceptionEnum.SavingFutureDateDenied:
                    returned = "SavingFutureDateDenied.Text";
                    break;
                ...
                case OpenCbsSavingExceptionEnum.ManagementFeesIsInvalid:
                    ...
                    break;
                case OpenCbsSavingExceptionEnum.InstrumentFeesIsInvalid:
                    returned = "SavingContractInstrumentFeesIsInvalid.Text";
                    break;
                case OpenCbsSavingExceptionEnum.SearchFeesIsInvalid:
                    returned = "SavingContractSearchFeesIsInvalid.Text";
                    break;
                case OpenCbsSavingExceptionEnum.OtherFeesIsInvalid:
                    returned = "SavingContractOtherFeesIsInvalid.Text";
                    break;
    ...
    public enum OpenCbsSavingExceptionEnum
    {
        ...
        SearchFeesIsInvalid,
        OtherFeesIsInvalid,
        SavingBackDateDenied,
        SavingFutureDateDenied,
    }
}
