...
namespace OpenCBS.ExceptionsHandler
{
	...
	public class OpenCbsSavingProductException : OpenCbsException
	{
        ...
        private static string FindException(OpenCbsSavingProductExceptionEnum exceptionId)
        {
            ...
            switch (exceptionId)
            {
                ...
                case OpenCbsSavingProductExceptionEnum.InstrumentFeesIsInvalid:
                    returned = "SavingProductInstrumentFeesIsInvalid.Text";
                    break;

                case OpenCbsSavingProductExceptionEnum.InstrumentFeesMinIsInvalid:
                    returned = "SavingProductInstrumentFeesMinIsInvalid.Text";
                    break;

                case OpenCbsSavingProductExceptionEnum.SearchFeesIsInvalid:
                    returned = "SavingProductSearchFeesIsInvalid.Text";
                    break;

                case OpenCbsSavingProductExceptionEnum.SearchFeesMinIsInvalid:
                    returned = "SavingProductSearchFeesMinIsInvalid.Text";
                    break;

                case OpenCbsSavingProductExceptionEnum.OtherFeesIsInvalid:
                    returned = "SavingProductOtherFeesIsInvalid.Text";
                    break;

                case OpenCbsSavingProductExceptionEnum.OtherFeesMinIsInvalid:
                    returned = "SavingProductOtherFeesMinIsInvalid.Text";
                    break;
    ...
    public enum OpenCbsSavingProductExceptionEnum
    {
        ...
        PeriodicityIsNotSet,
        InstrumentFeesMinIsInvalid,
        InstrumentFeesIsInvalid,
        SearchFeesMinIsInvalid,
        SearchFeesIsInvalid,
        OtherFeesMinIsInvalid,
        OtherFeesIsInvalid
