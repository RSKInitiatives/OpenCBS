    ...
    public partial class FrmTellerOperation : SweetBaseForm
    {
        ...
        private void InitializeBranch()
        {
            ...
            cmbBranch.DataSource =
                ServicesProvider.GetInstance().GetBranchService()
                .FindAllNonDeletedWithVault().OrderBy(item => item.Id).ToList();
        }
        ...
        private void InitializeTeller()
        {
            ...
            if (branch != null)
                tellers = ServicesProvider.GetInstance().GetTellerServices()
                    .FindAllNonDeletedTellersOfBranch(branch);
