...
//                    "", User.CurrentUser, false, OPaymentMethods.Cash, null, null);
                ServicesProvider.GetInstance().GetAccountServices().Deposit(saving, TimeProvider.Now, amount, 
                    "", "", User.CurrentUser, false, null, OSavingsMethods.Cash, new PaymentMethod(), null, null);
            }
        }
    }
}
