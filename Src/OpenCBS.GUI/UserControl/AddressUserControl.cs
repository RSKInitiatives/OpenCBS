...
namespace OpenCBS.GUI
{
    ...
    public partial class AddressUserControl : System.Windows.Forms.UserControl
    {
        ...
        public District District
        {
            ...
            {
                _district = value;
                _SetValue(_district, _city, _comments, _homePhone,_personalPhone,_zipCode,_email,_homeType, _smsDelivery, _emailDelivery);
            }
        }
        ...
        {
            get { return _emailDelivery; }
            set
            {
                _emailDelivery = value;
                _SetValue(_district, _city, _comments, _homePhone, _personalPhone, _zipCode, _email, _homeType, _smsDelivery, _emailDelivery);
            }
        }
        ...
        private void _SetValue(District pDistrict, string pCity, 
            string pComments,string pHomePhone,string pPersonalPhone,string pZipCode, string pEmail,string pHomeType, bool smsDelivery, bool emailDelivery)
        {
            if (pDistrict != null)
            {
            ...
            cbSMS.Checked = smsDelivery;
            cbEmail.Checked = emailDelivery;
        }
