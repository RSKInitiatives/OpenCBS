...
namespace OpenCBS.GUI.Accounting
{
    public partial class AccountView : Form
    {
        ...
        private void _InitializeComboBoxBranches()
        {
            ...
            exportCmbBranches.Items.Clear();
            exportCmbBranches.ValueMember = "Id";
            exportCmbBranches.DisplayMember = "";
            exportCmbBranches.DataSource = branches;
        }
        ...
        private void _InitializeListViewBookings(Account pAccount, DateTime pBeginDate, DateTime pEndDate, OBookingTypes pBookingType)
        {
            ...
            if (pAccount != null)
            {
                _bookingsStock = ServicesProvider.GetInstance().GetAccountingServices()
                    .FindAllBookings(pAccount, pBeginDate, pEndDate, ((Currency) (cmbCurrencies.SelectedItem)).Id , pBookingType, 
                    ((Branch) cmbBranches.SelectedItem).Id);
