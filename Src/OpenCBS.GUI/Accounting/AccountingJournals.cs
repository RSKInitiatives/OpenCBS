...
namespace OpenCBS.GUI.Accounting
{
    public partial class AccountingJournals : SweetBaseForm
    {
        ...
        private void GenerateSavingsClosureEvents()
        {
            ...
            _savings = ServicesProvider.GetInstance().GetAccountServices().SelectActiveContracts();
        ...
        private void GetBookings(ClosureOptions options)
        {
            ...
            if (options.DoSavingClosure)
            {
                ...
                eventStock.AddRange(
                    ServicesProvider.GetInstance().GetAccountServices().SelectEventsForClosure(
        ...
        private void BwPostEventsDoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                ServicesProvider.GetInstance().GetAccountServices().PostEvents(_savings, _eventStock.GetSavingEvents());
