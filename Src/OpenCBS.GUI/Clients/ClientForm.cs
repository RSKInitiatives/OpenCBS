...
namespace OpenCBS.GUI.Clients
{
    ...
    public partial class ClientForm : SweetForm
    {
        ...
        private static AccountServices SavingServices
        {
            get { return ServiceProvider.GetAccountServices(); }
        }
        ...
        public void DisplayClient(IClient pClient, Project project)
        {
            ...
            if (pClient is Person)
            {
                ...
                InitializeTitle(string.Format("{0} {1} - {2}", _person.FirstName, _person.LastName, _person.Id.ToString().PadLeft(4, '0')));
            }
            if (pClient is Group)
            {
        ...
        private void DisplaySavingProduct(ISavingProduct product)
        {
            ...
            if (product is SavingsBookProduct)
            {
                ...
                lbAMFees.Visible = true;
                nudAMFees.Visible = true;
                lbAMFeesMinMax.Visible = true;
                ...
                lbInstrumentFees.Visible = true;
                nudInstrumentFees.Visible = true;
                lbInstrumentFeesMinMax.Visible = true;

                lbSearchFees.Visible = true;
                nudSearchFees.Visible = true;
                lbSearchFeesMinMax.Visible = true;

                lbOtherFees.Visible = true;
                nudDutyStampFees.Visible = true;
                lbOtherFeesMinMax.Visible = true;
                ...
                // AM fees
                if (((SavingsBookProduct)product).AMFeesType == OSavingsFeesType.Flat)
                {
                    nudAMFees.DecimalPlaces = 0;
                    nudAMFees.Increment = 1;
                    if (((SavingsBookProduct)product).FlatAMFees.HasValue)
                    {
                        nudAMFees.Enabled = false;
                        nudAMFees.Minimum = ((SavingsBookProduct)product).FlatAMFees.Value;
                        nudAMFees.Maximum = ((SavingsBookProduct)product).FlatAMFees.Value;
                        lbAMFeesMinMax.Text = string.Format("{0} {1}", ((SavingsBookProduct)product).FlatAMFees.GetFormatedValue(product.Currency.UseCents), product.Currency.Code);
                    }
                    else
                    {
                        nudAMFees.Enabled = true;
                        nudAMFees.Minimum = ((SavingsBookProduct)product).FlatAMFeesMin.Value;
                        nudAMFees.Maximum = ((SavingsBookProduct)product).FlatAMFeesMax.Value;
                        lbAMFeesMinMax.Text = string.Format("{0}{1} {4}\r\n{2}{3} {4}",
                            "Min ", ((SavingsBookProduct)product).FlatAMFeesMin.GetFormatedValue(product.Currency.UseCents),
                            "Max ", ((SavingsBookProduct)product).FlatAMFeesMax.GetFormatedValue(product.Currency.UseCents),
                            product.Currency.Code);
                    }
                }
                else
                {
                    nudAMFees.DecimalPlaces = 4;
                    nudAMFees.Increment = 0.0001m;
                    if (((SavingsBookProduct)product).RateAMFees.HasValue)
                    {
                        nudAMFees.Enabled = false;
                        nudAMFees.Minimum = (decimal)((SavingsBookProduct)product).RateAMFees.Value * 100;
                        nudAMFees.Maximum = (decimal)((SavingsBookProduct)product).RateAMFees.Value * 100;
                        lbAMFeesMinMax.Text = string.Format("{0} {1}", (((SavingsBookProduct)product).RateAMFees * 100), "%");
                    }
                    else
                    {
                        nudAMFees.Enabled = true;
                        nudAMFees.Minimum = (decimal)((SavingsBookProduct)product).RateAMFeesMin.Value * 100;
                        nudAMFees.Maximum = (decimal)((SavingsBookProduct)product).RateAMFeesMax.Value * 100;
                        lbAMFeesMinMax.Text = string.Format("{0}{1} {4}\r\n{2}{3} {4}",
                            "Min ", (((SavingsBookProduct)product).RateAMFeesMin * 100),
                            "Max ", (((SavingsBookProduct)product).RateAMFeesMax * 100),
                            "%");
                    }
                }
                ...
                //Instrument fees
                nudInstrumentFees.DecimalPlaces = 0;
                nudInstrumentFees.Increment = 1;

                if (((SavingsBookProduct)product).InstrumentFees.HasValue)
                {
                    nudInstrumentFees.Enabled = false;
                    nudInstrumentFees.Minimum = ((SavingsBookProduct)product).InstrumentFees.Value;
                    nudInstrumentFees.Maximum = ((SavingsBookProduct)product).InstrumentFees.Value;
                    lbInstrumentFeesMinMax.Text = string.Format("{0} {1}",
                                                             ((SavingsBookProduct)product).InstrumentFees.GetFormatedValue(product.Currency.UseCents),
                                                             product.Currency.Code);
                }
                else
                {
                    nudInstrumentFees.Enabled = true;
                    nudInstrumentFees.Minimum = ((SavingsBookProduct)product).InstrumentFeesMin.Value;
                    nudInstrumentFees.Maximum = ((SavingsBookProduct)product).InstrumentFeesMax.Value;
                    lbInstrumentFeesMinMax.Text = string.Format("{0}{1} {4}\r\n{2}{3} {4}",
                                                             "Min ", ((SavingsBookProduct)product).InstrumentFeesMin.GetFormatedValue(product.Currency.UseCents),
                                                             "Max ", ((SavingsBookProduct)product).InstrumentFeesMax.GetFormatedValue(product.Currency.UseCents),
                                                             product.Currency.Code);
                }

                //Search fees
                nudSearchFees.DecimalPlaces = 0;
                nudSearchFees.Increment = 1;

                if (((SavingsBookProduct)product).SearchFees.HasValue)
                {
                    nudSearchFees.Enabled = false;
                    nudSearchFees.Minimum = ((SavingsBookProduct)product).SearchFees.Value;
                    nudSearchFees.Maximum = ((SavingsBookProduct)product).SearchFees.Value;
                    lbSearchFeesMinMax.Text = string.Format("{0} {1}",
                                                             ((SavingsBookProduct)product).SearchFees.GetFormatedValue(product.Currency.UseCents),
                                                             product.Currency.Code);
                }
                else
                {
                    nudSearchFees.Enabled = true;
                    nudSearchFees.Minimum = ((SavingsBookProduct)product).SearchFeesMin.Value;
                    nudSearchFees.Maximum = ((SavingsBookProduct)product).SearchFeesMax.Value;
                    lbSearchFeesMinMax.Text = string.Format("{0}{1} {4}\r\n{2}{3} {4}",
                                                             "Min ", ((SavingsBookProduct)product).SearchFeesMin.GetFormatedValue(product.Currency.UseCents),
                                                             "Max ", ((SavingsBookProduct)product).SearchFeesMax.GetFormatedValue(product.Currency.UseCents),
                                                             product.Currency.Code);
                }

                //Other fees
                nudDutyStampFees.DecimalPlaces = 0;
                nudDutyStampFees.Increment = 1;

                if (((SavingsBookProduct)product).DutyStampFees.HasValue)
                {
                    nudDutyStampFees.Enabled = false;
                    nudDutyStampFees.Minimum = ((SavingsBookProduct)product).DutyStampFees.Value;
                    nudDutyStampFees.Maximum = ((SavingsBookProduct)product).DutyStampFees.Value;
                    lbOtherFeesMinMax.Text = string.Format("{0} {1}",
                                                             ((SavingsBookProduct)product).DutyStampFees.GetFormatedValue(product.Currency.UseCents),
                                                             product.Currency.Code);
                }
                else
                {
                    nudDutyStampFees.Enabled = true;
                    nudDutyStampFees.Minimum = ((SavingsBookProduct)product).DutyStampFeesMin.Value;
                    nudDutyStampFees.Maximum = ((SavingsBookProduct)product).DutyStampFeesMax.Value;
                    lbOtherFeesMinMax.Text = string.Format("{0}{1} {4}\r\n{2}{3} {4}",
                                                             "Min ", ((SavingsBookProduct)product).DutyStampFeesMin.GetFormatedValue(product.Currency.UseCents),
                                                             "Max ", ((SavingsBookProduct)product).DutyStampFeesMax.GetFormatedValue(product.Currency.UseCents),
                                                             product.Currency.Code);
                }
        ...
        private void Disburse()
        {
            try
            {
                ...
                loanDisbursementForm.Person = Person;
...
//                        ((MainView)_mdiParent).ReloadAlertsSync();
        ...
        private void DisplaySavingEvent(ISavingsContract pSaving)
        {
            ...
            if (pSaving.Id != 0)
            {
                ...
                nudAMFees.Value = nudAMFees.Minimum = nudAMFees.Maximum = s.FlatAMFees.HasValue ?
                    s.FlatAMFees.Value : (decimal)s.RateAMFees.Value * 100;
                ...
                nudDutyStampFees.Value = nudDutyStampFees.Minimum = nudDutyStampFees.Maximum = ((SavingBookContract)pSaving).DutyStampFees.Value;
                nudInstrumentFees.Value = nudInstrumentFees.Minimum = nudInstrumentFees.Maximum = ((SavingBookContract)pSaving).InstrumentFees.Value;
                nudSearchFees.Value = nudSearchFees.Minimum = nudSearchFees.Maximum = ((SavingBookContract)pSaving).SearchFees.Value;
            ...
            var foundAction = role.GetActionItems().Where(a=>a.Key.MethodName == "CancelLastOperation").FirstOrDefault();

            var cancelLastOperationActionAllowed = false;
            
            if (foundAction.Key != null)                
                cancelLastOperationActionAllowed = role.IsActionAllowed(foundAction.Key);                                    

            /*
            var userRoleId = role.Id;
            
            var roleService = ServicesProvider.GetInstance().GetRoleServices();
            var actionsAllowed = roleService.GetAllowedActionList(userRoleId);
            
            foreach (var action in actionsAllowed) 
            {
                if (action.Key.ClassName == "AccountServices" && action.Key.MethodName == "CancelLastOperation")
                {
                    cancelLastOperationActionAllowed = roleService.IsThisActionAllowedForThisRole(userRoleId, action.Key);            
                    break;
                }
            }
            */
            btCancelLastSavingEvent.Enabled = _saving.HasCancelableEvents() && cancelLastOperationActionAllowed;
            ...
            foreach (SavingEvent e in events)
            {
                ...
                item.SubItems.Add(e.ReferenceNumber);
        ...
        private void buttonFirstDeposit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    _saving = (SavingBookContract)SavingServices.GetSaving(_saving.Id);
        ...
        private void buttonSaveSaving_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (savingBookProduct.AMFeesType == OSavingsFeesType.Flat)
                    savingBookContract.FlatAMFees = nudAMFees.Value;
                else
                    savingBookContract.RateAMFees = (double)nudAMFees.Value / 100;
                ...
                savingBookContract.InstrumentFees = nudInstrumentFees.Value;
                savingBookContract.SearchFees = nudSearchFees.Value;
                savingBookContract.DutyStampFees = nudDutyStampFees.Value;
        ...
        {
            if (!CheckDataInOpenFiscalYear()) return;
            var savingsOperationForm = new SavingsOperationForm(_saving, OSavingsOperation.Credit);            
            savingsOperationForm.Person = Person;            
            ...
            try
            {
                ...
                if (result == DialogResult.OK)
                {
                    try
                    {
                        ...
                        List<SavingEvent> sEvents = SavingServices.CancelLastEvent(_saving, User.CurrentUser, frm.Comment);

                        foreach (SavingEvent sEvent in sEvents)
                        {
...
//                    ((MainView)_mdiParent).ReloadAlertsSync();
        ...
        private void buttonCloseSaving_Click(object sender, EventArgs e)
        {
            ...
            while (closeSavingsForm.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    {
                        AccountServices savingService = SavingServices;
        ...
        {
            if (!CheckDataInOpenFiscalYear()) return;
            var savingsOperationForm = new SavingsOperationForm(_saving, OSavingsOperation.Transfer);
            savingsOperationForm.Person = Person;
            savingsOperationForm.ShowDialog();
            _saving = (SavingBookContract)SavingServices.GetSaving(_saving.Id);
            DisplaySavingEvent(_saving);
...
//            ((MainView)_mdiParent).ReloadAlertsSync();
        ...
        private void btSearchContract_Click(object sender, EventArgs e)
        {
                ...
                == DialogResult.OK)
            {
                ...
                try
                {
                    ServicesProvider.GetInstance().GetAccountServices().CheckIfTransferAccountHasWrongCurrency(
        ...
        private void menuItemConfirmPendingSavingEvent_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SavingServices.Deposit(_saving, TimeProvider.Now,
                    savEvent.Amount, savEvent.Description, savEvent.ReferenceNumber, User.CurrentUser, false, null, (OSavingsMethods)savEvent.SavingsMethod, new PaymentMethod(), savEvent.Id, Teller.CurrentTeller);
