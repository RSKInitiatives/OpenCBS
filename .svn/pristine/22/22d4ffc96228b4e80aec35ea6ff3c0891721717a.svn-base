    ...
    public class FrmGeneralSettings : SweetBaseForm
    {
        ...
        private void InitializeListViewGeneralParameters()
        {
            ...
            foreach (object key in keys)
            {
                ...
                if (val.Key.ToString() == OGeneralSettings.USE_EXTERNAL_ACCOUNTING) 
                {
                ...
                if (val.Value != null)
                {
                    if (val.Key.ToString() == OGeneralSettings.PAYFIRSTINSTALLMENTREALVALUE ||
                        ...
                        val.Key.ToString() == OGeneralSettings.ENABLE_SMS_MESSAGING ||
                        val.Key.ToString() == OGeneralSettings.AUTOMATE_CHEQUE_DEPOSIT)
                    {
        ...
        private void InitializeControls()
        {
            if (entry.Key.ToString() == OGeneralSettings.PAYFIRSTINSTALLMENTREALVALUE ||
                ...
                entry.Key.ToString() == OGeneralSettings.ENABLE_SMS_MESSAGING ||
                entry.Key.ToString() == OGeneralSettings.AUTOMATE_CHEQUE_DEPOSIT)
            {
