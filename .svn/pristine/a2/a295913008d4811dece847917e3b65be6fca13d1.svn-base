...
namespace OpenCBS.CoreDomain.Products
{
	...
	public class SavingsBookProduct : ISavingProduct
    {
        ...
        public OCurrency AMMin { get; set; }
        public OCurrency AMMax { get; set; }
        ...
        public OCurrency InstrumentFeesMin { get; set; }
        public OCurrency InstrumentFeesMax { get; set; }
        public OCurrency InstrumentFees { get; set; }
        public OCurrency SearchFeesMin { get; set; }
        public OCurrency SearchFeesMax { get; set; }
        public OCurrency SearchFees { get; set; }
        public OCurrency DutyStampFeesMin { get; set; }
        public OCurrency DutyStampFeesMax { get; set; }
        public OCurrency DutyStampFees { get; set; }

        public OCurrency FlatAMFeesMin { get; set; }
        public OCurrency FlatAMFeesMax { get; set; }
        public OCurrency FlatAMFees { get; set; }

        private OSavingsFeesType amFeesType = OSavingsFeesType.Rate;
        public OSavingsFeesType AMFeesType
        {
            get { return amFeesType; }
            set { amFeesType = value; }
        }
        public double? RateAMFeesMin { get; set; }
        public double? RateAMFeesMax { get; set; }
