...
namespace OpenCBS.GUI.Tools
{
    public partial class PasswordForm : SweetOkCancelForm
    {
        ...
        public PasswordForm(User user)
        {
            ...
            textBoxSecretQuestion.Text = user.Secret.Question;
        }
        ...
        private void PasswordForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (!userService.ValidatePassword(User.UserName, textBoxOldPswd.Text))
            {
            ...
            else if (String.IsNullOrEmpty(textBoxSecretQuestion.Text))
            {
                Fail("secretQuestionEmpty");
                e.Cancel = true;
            }
            else if (String.IsNullOrEmpty(textBoxSecretQuestionAnswer.Text))
            {
                Fail("secretQuestionAnswerEmpty");
                e.Cancel = true;
            }
            NewPassword = textBoxNewPswd.Text;
            SecretQuestion = textBoxSecretQuestion.Text;
            SecretQuestionAnswer = textBoxSecretQuestionAnswer.Text;
        }
    }
}
