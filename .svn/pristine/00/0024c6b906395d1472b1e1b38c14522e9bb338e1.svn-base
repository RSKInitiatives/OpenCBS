...
namespace OpenCBS.Manager
{
    ...
    public class RoleManager : Manager
    {
        ...
        {
            string q = @"SELECT MenuItems.[id], MenuItems.[component_name], MenuItems.[parent_name], MenuItems.[friendly_name], 
                              AllowedRoleMenus.allowed 
                              FROM [MenuItems] 
                                    ...
                                    Menus.Add(new MenuObject
                                                  {
                                                      ...
                                                      ParentName = r.GetString("parent_name"),
                                                      FriendlyName = r.GetString("friendly_name"),
