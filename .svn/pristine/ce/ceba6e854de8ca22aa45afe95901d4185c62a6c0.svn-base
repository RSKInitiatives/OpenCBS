...
{
    public partial class SavingsCodeForm : Form
    {
        private readonly User _user;

        public SavingsCodeForm()
        {
            InitializeComponent();
            _user = new User();
            ApplicationSettings appSettings = ApplicationSettings.GetInstance(_user.Md5);
            string code = ServicesProvider.GetInstance().GetGeneralSettings().SavingsCodeTemplate;
            ...
            tbCode.Text = appSettings.SavingsCodeTemplate;
        }
