...
namespace OpenCBS.Services
{
    ...
    public class ClientServices : ContextBoundObject
    {
        ...
        private void CheckPersonFilling(Person person)
        {
            ...
            */
            ...
            if (String.IsNullOrEmpty(person.ImagePath))
                throw new OpenCbsTiersSaveException(OpenCbsTiersSaveExceptionEnum.PassportIsNull);
            if (String.IsNullOrEmpty(person.Image3Path))
                throw new OpenCbsTiersSaveException(OpenCbsTiersSaveExceptionEnum.SignatureIsNull);
            if ((int)person.ParticularsType < 0)
                throw new OpenCbsTiersSaveException(OpenCbsTiersSaveExceptionEnum.ParticularsTypeIsNull);
            if (String.IsNullOrEmpty(person.ParticularsIDNumber))
                throw new OpenCbsTiersSaveException(OpenCbsTiersSaveExceptionEnum.ParticularsIDNumberIsNull);
            if (person.ParticularsIssueDate == null)
                throw new OpenCbsTiersSaveException(OpenCbsTiersSaveExceptionEnum.ParticularsIssueDateIsNull);
            if (person.ParticularsExpiryDate == null)
                throw new OpenCbsTiersSaveException(OpenCbsTiersSaveExceptionEnum.ParticularsExpiryDateIsNull);

            if (person.ParticularsIssueDate != null && person.ParticularsExpiryDate != null) 
            {
                if (person.ParticularsIssueDate > person.ParticularsExpiryDate)
                throw new OpenCbsTiersSaveException(OpenCbsTiersSaveExceptionEnum.ParticularsDateIslnvalid);                               
            }
        ...
        private void SavePicture(Person person)
        {
            ...
            if (person.IsImage3Updated)
                _picturesServices.UpdatePicture("PERSON", person.Id, 2, person.Image3Path);
            if (person.IsImage3Deleted)
                _picturesServices.DeletePicture("PERSON", person.Id, 2);
            if (!string.IsNullOrEmpty(person.Image3Path) && person.IsImage3Added)
                _picturesServices.AddPicture("PERSON", person.Id, 2, person.Image3Path);
        }
