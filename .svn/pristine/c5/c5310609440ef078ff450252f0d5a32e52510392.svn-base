...
namespace OpenCBS.ExceptionsHandler
{
		...
		private string FindException(OpenCbsTiersSaveExceptionEnum exceptionId)
		{
			...
			switch(exceptionId)
			{
				case OpenCbsTiersSaveExceptionEnum.TiersIsNull:
                    ...
                    //slycode
                case OpenCbsTiersSaveExceptionEnum.SignatureIsNull:
                    returned = "SignatureIsNull.Text";
                    break;
                case OpenCbsTiersSaveExceptionEnum.PassportIsNull:
                    returned = "PassportIsNull.Text";
                    break;
                case OpenCbsTiersSaveExceptionEnum.ParticularsTypeIsNull:
                    returned = "ParticularsTypeIsNull.Text";
                    break;
                case OpenCbsTiersSaveExceptionEnum.ParticularsIDNumberIsNull:
                    returned = "ParticularsIDNumberIsNull.Text";
                    break;
                case OpenCbsTiersSaveExceptionEnum.ParticularsIssueDateIsNull:
                    returned = "ParticularsIssueDateIsNull.Text";
                    break;
                case OpenCbsTiersSaveExceptionEnum.ParticularsExpiryDateIsNull:
                    returned = "ParticularsExpiryDateIsNull.Text";
                    break;
                case OpenCbsTiersSaveExceptionEnum.ParticularsDateIslnvalid:
                    returned = "ParticularsDateIslnvalid.Text";
                    break;
    ...
    public enum OpenCbsTiersSaveExceptionEnum
    {
        ...
        SignatureIsNull,
        PassportIsNull,
        ParticularsTypeIsNull,
        ParticularsIDNumberIsNull,
        ParticularsIssueDateIsNull,
        ParticularsExpiryDateIsNull,
