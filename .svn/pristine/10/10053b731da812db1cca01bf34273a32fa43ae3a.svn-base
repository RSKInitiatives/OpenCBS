...
namespace OpenCBS.GUI.Configuration
{
    public partial class FrmAddSavingBookProduct : SweetBaseForm
    {
        ...
        public FrmAddSavingBookProduct()
        {
            ...
            lblDutyStampValidity.Text = "Valid above =N=" + Convert.ToString(ApplicationSettings.GetInstance("").GetSpecificParameter(OGeneralSettings.STAMP_DUTY_VALID_ABOVE));
        ...
        private void InitializeControls(SavingsBookProduct product)
        {
            ...
            if (_savingsProduct.AMFeesType == OSavingsFeesType.Flat)
            {
                if (_savingsProduct.FlatAMFees.HasValue)
                    tbAMFeesValue.Text = _savingsProduct.FlatAMFees.GetFormatedValue(_savingsProduct.UseCents);
                if (_savingsProduct.FlatAMFeesMin.HasValue)
                    tbAMFeesMin.Text = _savingsProduct.FlatAMFeesMin.GetFormatedValue(_savingsProduct.UseCents);
                if (_savingsProduct.FlatAMFeesMax.HasValue)
                    tbAMFeesMax.Text = _savingsProduct.FlatAMFeesMax.GetFormatedValue(_savingsProduct.UseCents);
                rbFlatAMFees.Checked = true;
            }
            else
            {
                if (_savingsProduct.RateAMFees.HasValue)
                    tbAMFeesValue.Text = (_savingsProduct.RateAMFees.Value * 100).ToString();
                if (_savingsProduct.RateAMFeesMin.HasValue)
                    tbAMFeesMin.Text = (_savingsProduct.RateAMFeesMin.Value * 100).ToString();
                if (_savingsProduct.RateAMFeesMax.HasValue)
                    tbAMFeesMax.Text = (_savingsProduct.RateAMFeesMax.Value * 100).ToString();
                rbRateAMFees.Checked = true;
            }
            ...
            if (_savingsProduct.InstrumentFees.HasValue)
                tbInstrumentFeesValue.Text = _savingsProduct.InstrumentFees.GetFormatedValue(_savingsProduct.UseCents);
            if (_savingsProduct.InstrumentFeesMin.HasValue)
                tbInstrumentFeesMin.Text = _savingsProduct.InstrumentFeesMin.GetFormatedValue(_savingsProduct.UseCents);
            if (_savingsProduct.InstrumentFeesMax.HasValue)
                tbInstrumentFeesMax.Text = _savingsProduct.InstrumentFeesMax.GetFormatedValue(_savingsProduct.UseCents);

            if (_savingsProduct.SearchFees.HasValue)
                tbSearchFeesValue.Text = _savingsProduct.SearchFees.GetFormatedValue(_savingsProduct.UseCents);
            if (_savingsProduct.SearchFeesMin.HasValue)
                tbSearchFeesMin.Text = _savingsProduct.SearchFeesMin.GetFormatedValue(_savingsProduct.UseCents);
            if (_savingsProduct.SearchFeesMax.HasValue)
                tbSearchFeesMax.Text = _savingsProduct.SearchFeesMax.GetFormatedValue(_savingsProduct.UseCents);

            if (_savingsProduct.DutyStampFees.HasValue)
                tbDutyStampFeesValue.Text = _savingsProduct.DutyStampFees.GetFormatedValue(_savingsProduct.UseCents);
            if (_savingsProduct.DutyStampFeesMin.HasValue)
                tbDutyStampFeesMin.Text = _savingsProduct.DutyStampFeesMin.GetFormatedValue(_savingsProduct.UseCents);
            if (_savingsProduct.DutyStampFeesMax.HasValue)
                tbDutyStampFeesMax.Text = _savingsProduct.DutyStampFeesMax.GetFormatedValue(_savingsProduct.UseCents);
        ...
        private void tbInstrumentFeesMin_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.InstrumentFeesMin = CheckAmount(tbInstrumentFeesMin, true, false);
        }

        private void tbInstrumentFeesMax_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.InstrumentFeesMax = CheckAmount(tbInstrumentFeesMax, true, false);
        }

        private void tbInstrumentFees_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.InstrumentFees = CheckAmount(tbInstrumentFeesValue, true, false);
        }

        private void tbSearchFeesMin_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.SearchFeesMin = CheckAmount(tbSearchFeesMin, true, false);
        }

        private void tbSearchFeesMax_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.SearchFeesMax = CheckAmount(tbSearchFeesMax, true, false);
        }

        private void tbSearchFees_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.SearchFees = CheckAmount(tbSearchFeesValue, true, false);
        }

        private void tbDutyStampFeesMin_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.DutyStampFeesMin = CheckAmount(tbDutyStampFeesMin, true, false);
        }

        private void tbDutyStampFeesMax_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.DutyStampFeesMax = CheckAmount(tbDutyStampFeesMax, true, false);
        }

        private void tbDutyStampFees_TextChanged(object sender, EventArgs e)
        {
            _savingsProduct.DutyStampFees = CheckAmount(tbDutyStampFeesValue, true, false);
        }


        private void tbAMFeesMin_TextChanged(object sender, EventArgs e)
        {
            if (rbFlatAMFees.Checked)
                _savingsProduct.FlatAMFeesMin = CheckAmount(tbAMFeesMin, true, false);
            else
                _savingsProduct.RateAMFeesMin = CheckAmount(tbAMFeesMin, false);
        }

        private void tbAMFeesMax_TextChanged(object sender, EventArgs e)
        {
            if (rbFlatAMFees.Checked)
                _savingsProduct.FlatAMFeesMax = CheckAmount(tbAMFeesMax, true, false);
            else
                _savingsProduct.RateAMFeesMax = CheckAmount(tbAMFeesMax, false);
        }

        private void tbAMFeesValue_TextChanged(object sender, EventArgs e)
        {
            if (rbFlatAMFees.Checked)
                _savingsProduct.FlatAMFees = CheckAmount(tbAMFeesValue, true, false);
            else
                _savingsProduct.RateAMFees = CheckAmount(tbAMFeesValue, false);
        }
        ...
        private void tbCodeSavingProduct_KeyPress(object sender, KeyPressEventArgs e)
        {
