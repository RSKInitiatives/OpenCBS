...
namespace OpenCBS.CoreDomain.Products
{
    public interface ISavingProduct
    {
        ...
        OCurrency AMMin { get; set; }
        OCurrency AMMax { get; set; }
        ...
        OCurrency InstrumentFeesMin { get; set; }
        OCurrency InstrumentFeesMax { get; set; }
        OCurrency InstrumentFees { get; set; }
        OCurrency SearchFeesMin { get; set; }
        OCurrency SearchFeesMax { get; set; }
        OCurrency SearchFees { get; set; }
        OCurrency DutyStampFeesMin { get; set; }
        OCurrency DutyStampFeesMax { get; set; }
        OCurrency DutyStampFees { get; set; }

        OCurrency FlatAMFeesMin { get; set; }
        OCurrency FlatAMFeesMax { get; set; }
        OCurrency FlatAMFees { get; set; }
